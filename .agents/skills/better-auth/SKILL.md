...
- **React Social Login Guide**: See `references/react-social-login-guide.md` for React/Vite social login implementation (recommended)
- **Social Login Integration**: See `references/social-login-integration.md` for unified mobile/web OAuth flow with Google and Apple providers
